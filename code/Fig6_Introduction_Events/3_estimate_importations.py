...
def format_seq_name(seq_name):
	return(seq_name.replace('hMpxV/', '').split('|')[0].replace(' ', ''))
...
def main():
	...
	parser.add_argument('--tree_file', 
						...
						default='results/aligned.ufboot')
	...
	parser.add_argument('--tree_times_file', default='results/ml_refined_node_times.csv')
